...
class CustomEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.steer_max = np.deg2rad(45); self.steer_min = np.deg2rad(-45)
    ...
    def reset(self, seed=None, options=None):
        ...
        theta = np.arctan2(target_y - y, target_x - x) + np.deg2rad(np.random.uniform(-45, 45)) 
    ...
    def reward(self, observation, step_count):
        ...
        termination = self.distance_target < 0.1
